...
int main()
{
  ...
  while (1)
  {
    ...
    if (strcmp(src_ip, "192.168.43.97") == 0 && strcmp(dest_ip, "192.168.43.215") == 0)//替换为实际IP地址
    {
      // 获取当前系统时间
      time_t rawtime;
      struct tm *timeinfo;
      ...
      unsigned char target_mac[ETH_ALEN] = {0x00, 0x0c, 0x29, 0x31, 0xad, 0xbd}; //  替换为实际的目标 MAC 地址00:0c:29:31:ad:bd
